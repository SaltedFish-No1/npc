...
const ENV_API_BASE_URL = (import.meta.env.VITE_NPC_API_BASE_URL as string | undefined)?.replace(
  /\/$/,
  ''
);
 ...
 */
export const NPC_API_BASE_URL = ENV_API_BASE_URL ?? DEV_PROXY_BASE_URL ?? DEFAULT_BACKEND_BASE_URL;
export const NPC_API_KEY = ((import.meta.env.VITE_NPC_API_KEY as string) ?? '').trim();
